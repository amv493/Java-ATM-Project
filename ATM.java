...
public class ATM {
    ...
    public static void main(String[] args) {
        ...
        User newUser = theBank.addUser("John", "Doe", "1234");
    ...
    public static User mainMenuPrompt(Bank theBank, Scanner sc) {
        ...
        // prompt the user for user ID/pin combo until a codrrect one is reached
        do {
            System.out.printf("\n\nWelcome to %\n\n", theBank.getName());
    ...
    /**
     * Process transferring funds from onen account to another 
     * @param theUser       the logged-in User object
     * @param sc            the Scanner object used for user input 
     */
     ...
     * @param theUser       the logged-in User ojbect
     * @param sc            the Scanner object used for user input
     */
